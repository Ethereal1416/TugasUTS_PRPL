          ...
          <div class="col-md-12">
            <div class="card card-primary">
              ...
              <form method="post" action="">
            	...
            	$sql = mysqli_query($koneksi,"SELECT * from peminjaman INNER JOIN barangg ON peminjaman.kode=barang.kode INNER JOIN user ON peminjaman.id_peminjam=user.id where id='$id_peminjaman'");      
					$tampil = $sql->fetch_assoc();
                ?>
                <div class="card-body">
                  <div class="form-group">
                    <label for="kode">Kode Barang</label>
                    <input type="text" name="kode" class="form-control" id="kode" placeholder="Masukkan Kode Barang" value="<?= $tampil['nama'] ?>">
                  </div>
                  <div class="form-group">
